                        ...
                        <div class="content">
                            <div class="module">
                                ...
                                <div class="module-body table">
                                    ...
                                    <?php } elseif(isset($_GET['del']) && $_GET['del'] == 'error') {?>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped display" width="100%">
                                        ...
                                        <tbody>
                                            <?php 
                                            $query = mysqli_query($bd, "SELECT * FROM president");
                                            $cnt=1;
                                            while($row = mysqli_fetch_array($query))
                                            {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="delete-user.php?id=<?php echo htmlentities($row['id']);?>&type=president" title="Delete user">
